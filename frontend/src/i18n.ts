...
const strings = {
  de: {
    ...
    ariaMoreToggle: "Weitere Optionen",
    ariaMap: "Karte",
    ...
    ariaStatsToggle: "Statistik-Ansicht öffnen",
    ariaStatsPanel: "Statistik-Ansicht",
    statsTitle: "Statistiken",
    statsChartTitle: "Stationen mit mehrfacher Preiserhöhung",
    statsTooltipLabel: "Stationen",
    statsLoadError: "Daten konnten nicht geladen werden.",
    chartTypeBar: "Balken",
    chartTypeLine: "Linie",
    chartTypeDot: "Punkte",
    weekdayLocale: "de-DE",
  ...
  en: {
    ...
    ariaStatsToggle: "Open statistics view",
    ariaStatsPanel: "Statistics view",
    statsTitle: "Statistics",
    statsChartTitle: "Stations with multiple price increases",
    statsTooltipLabel: "stations",
    statsLoadError: "Could not load data.",
    chartTypeBar: "Bar",
    chartTypeLine: "Line",
    chartTypeDot: "Dots",
    weekdayLocale: "en-GB",
